...
public class FunctionalInterface {
    public static void main(String[] args){
        ...
        listOfStudents.add(new Student(1010, "Chris", 89.8, "Computers"));

        //checking specialization of student in mathematics
        //(Tests an object)
        ...
        //Displaying all student with their percentage
        //(consumes an object)
        ...
        //Extracting only the names of all students
        //(Applies to an object)
        Function<Student, String> nameFunction = (Student Student) -> {
        ...
        //(Supplies the object)
        Supplier<Student> studentSupplier = () -> new Student(111111,
                "New Student", 92.9, "Java 8");
